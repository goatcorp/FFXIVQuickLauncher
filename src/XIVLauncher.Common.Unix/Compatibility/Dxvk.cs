...
public static class Dxvk
{
    ...
    public static async Task InstallDxvk(HttpClient client, DirectoryInfo prefix, DirectoryInfo installDirectory)
    {
        ...
        if (!Directory.Exists(dxvkPath))
        {
            ...
            await DownloadDxvk(client, installDirectory).ConfigureAwait(false);
        }
    ...
    private static async Task DownloadDxvk(HttpClient client, DirectoryInfo installDirectory)
    {
